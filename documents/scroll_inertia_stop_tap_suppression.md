...
- scroll inertia が自然停止した直後の
  `CONFIG_INPUT_IQS9151_SCROLL_INERTIA_STOP_TAP_SUPPRESS_MS` 以内に、
  全指離し状態から新しい接触列が始まった場合も停止ジェスチャーとして扱う。
...
- `test_two_finger_tap_after_scroll_inertia_natural_stop_suppresses_btn1`
- `test_two_finger_tap_after_scroll_inertia_stop_window_emits_btn1`
